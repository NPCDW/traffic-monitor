...
pub fn handle() {
    ...
    tokio::spawn(async {
        ...
        tracing::info!("got CTRL-SHUTDOWN. traffic-monitor is exiting");
        process::exit(0);
    });
    ...
    tokio::spawn(async {
        ...
        tracing::info!("got CTRL-C. traffic-monitor is exiting");
        process::exit(0);
    });
}
...
pub fn handle() {
    ...
    tokio::spawn(async {
        ...
        sig.recv().await;
        tracing::info!("got SIGTERM signal. traffic-monitor is exiting");
        process::exit(0);
    });
